        ...
        <div className="w-full relative overflow-hidden">
          ...
          >
            {[...certifications, ...certifications].map((cert, idx) => (
              <div
                key={cert.title + idx}
                className="group flex flex-col bg-card shadow-md border-2 border-accent hover:border-4 hover:border-accent w-[280px] aspect-[2/1] shrink-0 p-4 justify-between mx-[20px] my-[5px] rounded-md transition-transform duration-300 ease-out hover:scale-105 hover:shadow-lg"
              >
